...
public class erstelleFall {
    ...
    public static String strafmaßAusgeben(final String s) { // sucht das strafmaß bzw. den beschluss und gibt ihn zurück
        //strafmaß --> beschlossen:
    ...
    public static String VergehenAusgeben(final String s) {
        // Vergehen
